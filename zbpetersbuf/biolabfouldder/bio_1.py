...
def fcs():
    ...
    popt, pcov = curve_fit(custom_model, lag_filtered, correlation_filtered, p0=[1000, 1000, 2])  # Initial guesses
    ...
    plt.ylim(-0.1, 10)  # Set y-axis limits for better visibility
    plt.legend()
    plt.grid(True)
    plt.show()